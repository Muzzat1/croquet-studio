...
const DEMO_SEGMENTS: DemoSegment[] = [
  ...
  { start: [0.0, 0.133375, 5.5], end: [0.6, 0.133375, 0.0], hoop: "Hoop 6 (N Center)", desc: "Positioning slightly wide of peg for Hoop 6" },
  { start: [0.6, 0.133375, 0.0], end: [0.0, 0.133375, -4.0], hoop: "Hoop 6 (N Center)", desc: "Approaching Hoop 6 (North Center)" },
...
function TacticalTube({ points, color }: TacticalTubeProps) {
  ...
  return (
    <mesh castShadow>
      <tubeGeometry args={[curve, Math.max(30, points.length * 2), 0.04, 6, false]} />
      <meshStandardMaterial 
        color={color} 
        emissive={color} 
      ...
      <Canvas camera={{ position: [-31.49, 13.87, -0.11], fov: 45.0, far: 5000 }} shadows>
        ...
        {(() => {
          ...
          return (
            <Line 
              points={[
                [balls[selectedBall].x, 0.075, balls[selectedBall].z],
                [hoverPoint.x, 0.075, hoverPoint.z]
              ]} 
              color={
